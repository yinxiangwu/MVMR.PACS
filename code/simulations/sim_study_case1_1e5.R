...
write.csv(res_ivw,paste0("Res1e5/res_ivw_",task_id,".csv"),row.names = FALSE)
write.csv(res_ivw_inclusion,paste0("Res1e5/res_ivw_inclusion_",task_id,".csv"),row.names = FALSE)
write.csv(res_srivw,paste0("Res1e5/res_srivw_",task_id,".csv"),row.names = FALSE)
write.csv(res_srivw_inclusion,paste0("Res1e5/res_srivw_inclusion_",task_id,".csv"),row.names = FALSE)
write.csv(res_ivw_lasso,paste0("Res1e5/res_ivw_lasso_",task_id,".csv"),row.names = FALSE)
write.csv(res_dlasso,paste0("Res1e5/res_dlasso_",task_id,".csv"),row.names = FALSE)
write.csv(res_pacs_0.8,paste0("Res1e5/res_pacs_0.8_",task_id,".csv"),row.names = FALSE)
write.csv(res_pacs_v2,paste0("Res1e5/res_pacs_v2_",task_id,".csv"),row.names = FALSE)

write.csv(res_mrbma,paste0("Res1e5/res_mrbma_",task_id,".csv"),row.names = FALSE)
write.csv(mrbma_mip,paste0("Res1e5/mrbma_mip_",task_id,".csv"),row.names = FALSE)
write.csv(res_susie,paste0("Res1e5/res_susie_",task_id,".csv"),row.names = FALSE)
write.csv(susie_num_cluster,paste0("Res1e5/susie_num_cluster_",task_id,".csv"),row.names = FALSE)
write.csv(res_iv_strength,paste0("Res1e5/res_iv_strength_",task_id,".csv"),row.names = FALSE)
write.csv(res_cond_F,paste0("Res1e5/res_cond_F_",task_id,".csv"),row.names = FALSE)

write.csv(cluster_pacs_0.8,paste0("Res1e5/cluster_pacs_0.8_",task_id,".csv"),row.names = FALSE)
write.csv(cluster_pacs_v2,paste0("Res1e5/cluster_pacs_v2_",task_id,".csv"),row.names = FALSE)
